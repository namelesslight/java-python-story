...
public class QuestionController {
    ...
    public Result addTrainingQuestion(@RequestBody AddTrainingQuestionDto addQuestionDto){
        ...
        return new Result().result200(message, "/super/addQuestion");
    }
    ...
    public Result addAskQuestion(@RequestBody AddAskQuestionDto addAskQuestionDto){
        Map<String, Object> message = new HashMap<>();
    ...
    public Result updateQuestion(@RequestBody UpdateQuestionDto updateQuestionDto){
        Map<String, Object> message = new HashMap<>();
        ...
        return new Result().result200(message, "/super/updateQuestion");
    }
    ...
    public Result deleteQuestion(@RequestBody DeleteQuestionDto deleteQuestionDto){
        Map<String, Object> message = new HashMap<>();
        Integer deleteCode = questionService.deleteQuestion(deleteQuestionDto.getQuestionId());
        message.put("deleteCode", deleteCode);
        return new Result().result200(message, "/super/deleteQuestion");
    }
    ...
    public Result listQuestionByModel(@RequestParam Integer modelId){
        ...
        return new Result().result200(message, "/common/listQuestionByModel");
    }
    ...
    public Result queryOneQuestionById(@RequestParam Integer questionId){
        ...
        message.put("questionInfo", questionInfo);
        return new Result().result200(message, "/common/queryOneQuestionById");
    }
